...
public class JwtTokenServiceImpl implements JwtTokenService {
    ...
    public ResultResponse jwtTokenCreation(String email) {
        ...
        jwtTokenResponse.setMessage("Token created successfully");
    ...
    public ResultResponse verify(String token) {
        ...
        try{
            ...
            throw new ApiException(ResultStatus.TOKEN_EXPIRED, "Token Expired");
        } catch (Exception e) {
            throw new ApiException(ResultStatus.TOKEN_INVALID, "Token Invalid");
        }
    }
